...
<nav class="p-6 w-full flex flex-col flex-wrap">
    <ul class="space-y-1.5">
      <li><a class="flex items-center gap-x-3 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-slate-800 dark:text-slate-400 dark:hover:text-slate-300" href="#">
      ...
      <li><a class="flex items-center gap-x-3 py-2 px-2.5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-slate-800 dark:text-slate-400 dark:hover:text-slate-300" href="#">
        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
